...
class TestProductRoutes(TestCase):
    ...
    def test_get_product(self):
        ...
        # Use the _create_products() method to create one product, and then
        # assign the first product from the returned list to the test_product variable.
        test_product = self._create_products()[0]

        # Make a GET request to the API endpoint to retrieve the product and construct the URL
        # by appending the test_product.id to the BASE_URL
